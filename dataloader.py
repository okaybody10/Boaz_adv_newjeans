...
class MultimodalDataset(Dataset):
    ...
    def __init__(
        ...
        if not from_preprocessed_dataframe:
            ...
            if isinstance(from_preprocessed_dataframe, pd.DataFrame):
                ...
                print(from_preprocessed_dataframe)
        ...
        self.data_frame = df
        self.text_ids = set(self.data_frame['index'])
    ...
    def __getitem__(self, idx):
        ...
        item_id = int(self.data_frame.loc[idx, 'index'])
        ...
        if Modality(self.modality) in [Modality.TEXT, Modality.TEXT_IMAGE, \
            ...
            text = self.data_frame.loc[idx, 'title']
        ...
        if Modality(self.modality) in [Modality.IMAGE, Modality.TEXT_IMAGE, \
                                       Modality.TEXT_IMAGE_DIALOGUE]:
            image_path = os.path.join(self.image_dir, str(item_id) + IMAGE_EXTENSION)
    ...
    def _preprocess_df(self, df):
        def image_exists(row):
            ...
            image_path = os.path.join(self.image_dir, str(int(row['index'])) + IMAGE_EXTENSION)
            print(image_path)
            # print(image_path)
        ...
        print(f"filename_prefix: {self.saved_dataframe_filename_prefix}")
